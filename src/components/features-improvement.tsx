...
export const FeaturesImprovementSection = () => {
  ...
  return (
    <section className="relative mt-10 flex min-h-screen w-full  flex-col items-center md:p-10 lgxl:min-h-[800px] ">
      <div className="feature_box relative  h-[338px] w-[80%]  rounded-xl   md:block   ">
        <div className="flex  flex-col  justify-center   gap-5 p-10  md:absolute ">
          ...
          <h3
            className={cn(
              "text-center text-2xl font-semibold  text-white md:text-left md:text-[36px]",
              primary_font.className,
            )}
          >
      ...
      <div className="relative mb-10 flex w-[90%] -translate-y-[10%] flex-wrap items-center justify-center  gap-4  lg:-translate-y-[15%] lg:p-8 ">
