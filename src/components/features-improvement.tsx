...
export const FeaturesImprovementSection = () => {
    ...
    return (
        <section className="mt-10 relative min-h-screen lgxl:min-h-[800px] w-full  md:p-10 flex flex-col items-center ">
            <div className="relative md:block  feature_box rounded-xl  w-[80%]   h-[338px]   ">
                <div className="md:absolute  flex  flex-col   p-10 gap-5  justify-center ">
                    ...
                    <Button className={cn(" md:text-[20px] m-auto md:m-0 text-sm md:text-left text-center text-white bg-black w-fit",
                    ...
                    <h3 className={cn("md:text-[36px] text-center md:text-left  text-2xl font-semibold text-white", primary_font.className)}>
                ...
                <div className=" absolute flex w-full justify-between  items-end ">
                    <svg className="hidden md:block" width="339" height="298" viewBox="0 0 339 298" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.5">
                            <circle cx="282" cy="282" r="281.875" transform="matrix(-1 0 0 1 339 0)" stroke="#D9D9D9" strokeWidth="0.25" />
                            <circle cx="253" cy="253" r="252.75" transform="matrix(-1 0 0 1 258 81)" stroke="#D9D9D9" strokeWidth="0.5" />
                    ...
                    <svg className="hidden md:block" width="289" height="298" viewBox="0 0 289 298" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.5">
                            <circle cx="282" cy="282" r="281.875" stroke="#D9D9D9" strokeWidth="0.25" />
                            <circle cx="334" cy="334" r="252.75" stroke="#D9D9D9" strokeWidth="0.5" />
            ...
            <div className="relative -translate-y-[10%] lg:-translate-y-[15%] flex flex-wrap w-[90%] items-center justify-center  gap-4  lg:p-8 mb-10 ">
                {
