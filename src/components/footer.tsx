...
export const FooterSection = () => {
    return (
        <footer id="footer text-white">
            <section className="flex flex-col md:flex-row justify-around gap-y-8 p-8  py-10">
