      ...
      <div className=" bg_grid flex flex-col  gap-2 h-[90vh]">
        ...
        <div className="flex flex-col gap-4">
          <div className=" lg:w-[50rem] lgxl:w-[60rem] lgxl:h-12 h-12  relative m-auto flex flex-col  items-center  ">
            <div
              className="line absolute md:w-[30rem] md:h-[0.6px] top-[50%] 
            ...
            <Badge
              variant={"outline"}
              className={cn(
                "text-white  text-sm md:text-lg p-2 z-50 px-8 lgxl:p-4 lg2xl:p-6 lg3xl:p-8",
          ...
          <div className="md:max-w-[50%] max-w-[80%] lgxl:my-2 lg2xl:my-20 lg3xl:my-28 m-auto">
            <div className="mb-4">
              <h1
                className={cn(
                  "text-white md:mb-4 font-light  text-[28px] leading-[35.28px]  md:text-[48px] lg:text-[48px]",
                  "lgxl:text-[50px] lg2xl:text-[80px] lg3xl:text-[120px] text-center lgxl:p-4 lg2xl:p-8",
                  secondary_jakarta.className
                )}
              >
                Meet Your{" "}
            ...
            <p
              className={cn(
                "text-white leading-10 md:w-[100%] opacity-80 w-[100%] lgxl:p-2",
                "m-auto text-center font-thin md:text-[20px] text-[16px] lgxl:text-[20px] lg2xl:text-[24px] lg3xl:text-[50px] ",
                secondary_jakarta.className
              )}
            >
        ...
        <div className="flex flex-col gap-12 justify-around md:justify-start mt-14 md:mt-0">
          <div
            ...
            className="m-auto relative md:h-72  h-40  lgxl:h-70
