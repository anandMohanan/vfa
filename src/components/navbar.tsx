...
export const Navbar = async () => {
    return (
        <nav className={cn(" z-100 top-0 flex h-16 items-center gap-4 px-4 md:px-6 lg:mt-6 lg:mb-6 ", primary_font.className)}>
            <div className="flex md:w-full items-center justify-between ">
                <div className="hidden lg:flex gap-3 lg:flex-4">
                    <Link href={"/"} className="flex text-xl text-white font-semibold md:text-base">
                ...
                <div className="hidden lg:flex m-auto text-xl  lg:gap-x-6">
                    <Link
                        href={``}
            ...
            <Sheet>
                ...
                <SheetContent side="left" className="bg-black text-white">
                    <nav className="grid gap-6 text-lg font-medium">
                        ...
                        <Link
                            href={``}
                            className="text-white hover:text-cornflowerblue-400 "
                        >
                            Docs
                        </Link>
                        <Link
