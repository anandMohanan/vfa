...
export const OperationAutomationSection = () => {
    return (
        <section className="relative flex flex-col items-end justify-start max-w-full text-left md:mb-10 mt-40 lg:mt-56  text-white">
            <div className="flex flex-col max-w-full mt-10 ">
                <Button className=
                    {cn(" cursor-normal absolute top-[5%] md:top-[2%] left-[28%] lg:left-[42%] md:left-[38%] lgxl:left-[25%]  bg-[transparent] m-auto",
