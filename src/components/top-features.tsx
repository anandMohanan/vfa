...
export const TopFeaturesSection = () => {
  return (
    <section className=" w-[1262px] flex flex-col items-end justify-start gap-[29px] max-w-full text-left text-white">
      {/* Our Top Features Button */}
      <Button
        className="bg-black m-auto
                shadow-[0px_0px_6.9px_rgba(82,_79,_255,_0.15)]
                rounded-3xl overflow-hidden border-[0.3px] border-solid border-cornflowerblue-300 
                hover:bg-darkslategray-300 
              hover:border-cornflowerblue-600">
        Our Top 3 Features
      </Button>

      {/* Features Tab 1*/}
      <div className="flex flex-row gap-[45px] max-w-full lg:flex-wrap">
        {/* Right Side  */}
        <div className="flex-1 flex flex-col items-start justify-start pt-0 px-0 pb-[115px] box-border min-w-[431px] min-h-[431px] max-w-full mq800:min-w-full">
          <div className="flex flex-row items-start justify-start gap-[27px] max-w-full">
            <div className="flex-1 flex flex-col items-start justify-start pt-[19px] px-0 pb-0 box-border min-w-[373px] max-w-full mq450:min-w-full">
              <div className="self-stretch flex flex-col items-start justify-start gap-[23px] max-w-full">
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[8px] max-w-full">
                  <div
                    className="relative leading-[52px]
            ...
            <div className="center-line bg-green-500">
              ...
              <div className="line bg-green-600 w-1 "></div>
            </div>
          </div>
        </div>
        ...
        {/* Left Side */}
        <div
          className=" rounded-2xs bg-white overflow-hidden
