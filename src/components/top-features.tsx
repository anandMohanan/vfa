...
export const TopFeaturesSection = () => {
    return (
        ...
        <section className=" w-full p-10 ">
            <div className="relative flex items-center justify-center m-auto p-8">
                <Badge
                    variant={"outline"}
                    className={cn("text-white absolute z-10 text-sm md:text-lg p-2 px-8",
                ...
                <div className="hidden lg:block lg:absolute top-0 -z-40">
                    <LineSvg className=" " />
                </div>
            </div>
            <div className="flex lg:flex-row flex-col lg:gap-56 justify-evenly lg:p-36 p-10 ">
                <div className="flex flex-col gap-5 p-10 mb-10">
                    <Badge
                    ...
                    <p className={cn("text-white tracking-tight text-left md:text-xl text-sm leading-7 [&:not(:first-child)]:mt-6", primary_font.className)}>
            ...
            <div className="flex lg:flex-row-reverse flex-col gap-56 justify-evenly p-10">
