    ...
    return (
        ...
        <section className="top_section w-full ">
            <div className="relative hidden md:flex items-center justify-center  m-auto p-2">
                ...
                <Badge
                    variant={"outline"}
                    className={cn("text-white hidden md:block z-20 text-sm md:text-[30px] p-2 px-8",
                        "bg-black border-none font-[700px] ",
                    ...
                    <span className="text-transparent !bg-clip-text [background:linear-gradient(91.92deg,_#fff,_#698aff)]"
                    >
                        Your 24/7  AI Agents
                    </span>
                </Badge>
            </div>
            <div className="flex lg:flex-row flex-col md:gap-34 lg:gap-56  justify-between items-center  md:p-36 mt-5 lg:mt-0 ">
                <div className="flex flex-col  items-center lg:w-1/2  z-50  lgxl:p-0 md:items-start gap-5 md:p-6 mb-10 ">
                    ...
                    <h3 className={cn("text-white  text-[24px]  md:text-[35.94px] font-[500px]",
                        "text-center lg:text-left  lgxl:text-[40px] lg2xl:text-[50px] lg3xl:text-[50px]", secondary_jakarta.className)}>
                        Instant Support, No {" "}
                        <span className="
                    ...
                    <p className={
                        cn("text-white lg:w-[32rem] w-[20rem] md:w-[25rem] lgxl:w-[50rem] lg2xl:text-[36px] lgxl:leading-[60px] m-auto lg:m-0 tracking-tight font-thin opacity-80  lg:text-left text-center md:text-[1.25rem]",
                            "text-[1rem] leading-[27px] lgxl:leading-[32px] lgxl:text-[28px] lg2xl:text-[26px] lg3xl:text-[26px] ", secondary_jakarta.className)}>
                        Long wait times? Missed calls? Not on our watch. VoiceFirst Agents ensures every customer feels heard and helped, right when they need it
                    </p>
            ...
            <div className="flex lg:flex-row-reverse flex-col md:gap-34 lg:gap-56  items-center  md:p-36 mt-28 lg:mt-0 ">
                <div className="flex flex-col  items-center lg:w-1/2  z-50  lgxl:p-20 md:items-start gap-5 md:p-6 mb-10 ">
                    ...
                    > Agent-driven Outreach</Badge>
                            < h3 className = {
                                cn("text-white  text-[24px]  md:text-[35.94px] font-[500px]",
                                "text-center lg:text-left  lgxl:text-[50px] lg2xl:text-[50px] lg3xl:text-[50px]", secondary_jakarta.className)}>
                        ...
                        <p className={
                            cn("text-white lg:w-[32rem] w-[20rem] md:w-[25rem] lgxl:w-[50rem] m-auto lg:m-0 tracking-tight font-thin opacity-80  lg:text-left text-center md:text-[1.25rem]",
                                "text-[1rem] leading-[27px]  lgxl:text-[20px] lg2xl:text-[30px] lg3xl:text-[30px] ", secondary_jakarta.className)}>
