    ...
    return (
        ...
        <section className=" w-full p-10 ">
            ...
            <div className="flex lg:flex-row flex-col lg:gap-56 justify-evenly items-center lg:p-36 md:p-10 ">
                <div className="flex flex-col gap-5 md:p-10 mb-10">
                    <Badge
                    ...
                    <p className={
                        cn("text-white tracking-tight text-left md:text-xl text-sm leading-7 [&:not(:first-child)]:mt-6", primary_font.className)}>
