...
export const TopFeaturesSection = () => {
  return (
    <section className="top_section w-full">
      <div className="relative hidden lg:flex items-center justify-center m-auto p-2">
        ...
        <Badge
          variant={"outline"}
          className={cn(
            "text-white hidden md:block z-20 text-sm md:text-[30px] p-2 px-8",
      ...
      <div
        className="flex lg:flex-row flex-col md:gap-34 lg:gap-0 
        lg:p-0 lg:max-h-[80vh] mt-5 lg:mt-0"
      >
        <div
          className="lg:h-[80vh] flex flex-col lg:justify-center items-center
           lg:items-center lg:w-1/2 z-50 lgxl:p-0 
         gap-5 md:p-6 mb-10 lg:mb-0"
        >
          <div className="flex flex-col gap-6 ">
            <Badge
              className={cn(
                "text-white w-fit text-[16px] text-center m-auto lg:m-0  md:text-[20px]",
            ...
            <p
              className={cn(
                "text-white lg:w-[32rem] w-[20rem] md:w-[25rem] lgxl:w-[50rem] lg2xl:text-[36px] lgxl:leading-[60px] m-auto lg:m-0 tracking-tight font-thin opacity-80 lg:text-left text-center md:text-[1.25rem]",
                "text-[1rem] leading-[27px] lgxl:leading-[32px] lgxl:text-[28px] lg2xl:text-[26px] lg3xl:text-[26px]",
                secondary_jakarta.className
              )}
            >
            ...
            <Link
              ...
              className={cn(
                buttonVariants(),
                "rounded-none font-bold m-auto lg:m-0 w-fit",
        ...
        <div className=" lg:m-auto lg:min-w-[20rem] min-w-[30%] h-full p-10">
          <LottieAnimation ani={CustomerCallFlow} className="" />
        </div>
      </div>
      <div
        className="flex lg:flex-row-reverse flex-col md:gap-34 lg:gap-0 
        lg:p-0 lg:max-h-[80vh] mt-24 lg:mt-0 "
      >
        <div
          className="lg:h-[80vh] flex flex-col lg:justify-center items-center
           lg:items-center lg:w-1/2 z-50 lgxl:p-0 
        ...
        <div className=" lg:m-auto lg:min-w-[18rem] min-w-[30%] h-full  p-10 ">
